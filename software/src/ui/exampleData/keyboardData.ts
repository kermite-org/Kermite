...
export const exampleData_persistKeyboardDesign_shiro: IPersistKeyboardDesign = {
  formatRevision: 'LA01',
  setup: {
    placementUnit: 'KP 18 17',
    placementAnchor: 'center',
    keySizeUnit: 'KP 18 17',
    keyIdMode: 'auto',
  },
  keyEntities: [
    {
...
export const exampleData_persistKeyboardDesign_miniversRev2: IPersistKeyboardDesign = {
  formatRevision: 'LA01',
  setup: {
    placementUnit: 'KP 18 17',
    placementAnchor: 'center',
