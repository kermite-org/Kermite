...
import { useDesignConfigurationPanelModel } from '~/ui/layouter/editor/views/sidePanels_/models/DesignConfigurationPanel.model';
import { IConfigTextEditModel } from '~/ui/layouter/editor/views/sidePanels_/models/slots/ConfigTextEditModel';
