...
import { ConfigSubHeader } from '~/ui/layouter/editor/views/sidePanels_/atoms';
import { useTransGroupListPartModel } from '~/ui/layouter/editor/views/sidePanels_/models/TransGroupListPanel.model';
