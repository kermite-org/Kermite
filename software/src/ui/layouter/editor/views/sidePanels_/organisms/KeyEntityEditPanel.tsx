...
import { ConfigVStack } from '~/ui/layouter/editor/views/sidePanels_/atoms';
...
import { useKeyEntityEditPanelModel } from '~/ui/layouter/editor/views/sidePanels_/models/KeyEntityEditPanel.model';
