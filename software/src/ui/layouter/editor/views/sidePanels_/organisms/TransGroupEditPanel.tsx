...
import { useTransGroupEditPanelModel } from '~/ui/layouter/editor/views/sidePanels_/models/TransGroupEditPanel.model';
import { TransGroupListPart } from '~/ui/layouter/editor/views/sidePanels_/organisms/TransGroupListPart';
