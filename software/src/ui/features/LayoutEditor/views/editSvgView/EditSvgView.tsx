...
import {
  ...
  layouterAppFeatures,
  startDragSession,
} from '~/ui/features/LayoutEditor/common';
import { editMutations, editReader } from '~/ui/features/LayoutEditor/models';
import { CoordCursor } from '~/ui/features/LayoutEditor/views/editSvgView/svgParts/CoordCursor';
import { FieldGrid } from '~/ui/features/LayoutEditor/views/editSvgView/svgParts/FieldGrid';
import {
