...
import { useClosureModel } from '~/ui/features/LayoutEditor/common';
import {
  editMutations,
  editReader,
  IEditKeyEntity,
  IEditPropKey,
} from '~/ui/features/LayoutEditor/models';
import { getKeyIdentifierText } from '~/ui/features/LayoutEditor/models/DomainRelatedHelpers';
import {
  AttributeSlotModel,
  IAttributeSlotSource,
  IAttributeSlotViewModel,
} from '~/ui/features/LayoutEditor/views/sidePanels/models/slots/AttributeSlotModel';
import {
  createConfigTextEditModelDynamic2,
  IConfigTextEditModel2,
} from '~/ui/features/LayoutEditor/views/sidePanels/models/slots/ConfigTextEditModel';
import { makeSelectorModel } from '~/ui/features/LayoutEditor/views/sidePanels/models/slots/SelectorModel';
