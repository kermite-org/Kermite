...
import { getNextEntityInstanceId } from '~/ui/features/LayoutEditor/models/DomainRelatedHelpers';
import { editManager } from '~/ui/features/LayoutEditor/models/EditManager';
import {
  applyCoordSnapping,
  draftGetEditPoint,
} from '~/ui/features/LayoutEditor/models/EditorHelper';
import { IGridSpecKey } from '~/ui/features/LayoutEditor/models/GridDefinitions';
import {
  changeKeySizeUnit,
  changePlacementCoordUnit,
  mmToUnitValue,
} from '~/ui/features/LayoutEditor/models/PlacementUnitHelperEx';
import {
  appState,
