...
import {
  ...
  layouterAppFeatures,
  startDragSession,
} from '~/ui/editors/LayoutEditor/common';
import { editMutations, editReader } from '~/ui/editors/LayoutEditor/models';
import { CoordCursor } from '~/ui/editors/LayoutEditor/views/editSvgView/svgParts/CoordCursor';
import { FieldGrid } from '~/ui/editors/LayoutEditor/views/editSvgView/svgParts/FieldGrid';
import {
