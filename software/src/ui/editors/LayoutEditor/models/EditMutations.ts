...
import { getNextEntityInstanceId } from '~/ui/editors/LayoutEditor/models/DomainRelatedHelpers';
import { editManager } from '~/ui/editors/LayoutEditor/models/EditManager';
import {
  applyCoordSnapping,
  draftGetEditPoint,
} from '~/ui/editors/LayoutEditor/models/EditorHelper';
import { IGridSpecKey } from '~/ui/editors/LayoutEditor/models/GridDefinitions';
import {
  changeKeySizeUnit,
  changePlacementCoordUnit,
  mmToUnitValue,
} from '~/ui/editors/LayoutEditor/models/PlacementUnitHelperEx';
import {
  appState,
