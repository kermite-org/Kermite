...
import {
  ...
  DfuState,
  DfuStatus,
} from '~/shell/services/firmwareUpdation/flashSchemeAtmegaDfu/DfuConstants';
import { IDfuDeviceFunctionWrapper } from '~/shell/services/firmwareUpdation/flashSchemeAtmegaDfu/DfuDeviceFunctionWrapper';
