...
import { IMappingEntry, colors, generateNextSequentialId } from '~/app-shared';
import {
  GeneralButton,
  GeneralSelector,
  GeneralSelectorN,
...
} from '../ui_modal_routingPanel/actionRoutingPanelModel';
...
export const ActionRoutingPanel: FC = () => {
  ...
  const styleOverlayScale = getUnscaledOverlayStyle(
    profileEditorConfig.settings.siteDpiScale,
  );
