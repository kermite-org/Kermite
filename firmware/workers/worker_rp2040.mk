...
DEFINES += -DPICO_BIT_OPS_PICO=1
DEFINES += -DPICO_BOARD=\"pico\"
DEFINES += -DPICO_BOOT2_NAME=\"boot2_w25q080\"
...
DEFINES += -DPICO_DIVIDER_HARDWARE=1
DEFINES += -DPICO_DOUBLE_PICO=1
DEFINES += -DPICO_FLOAT_PICO=1
DEFINES += -DPICO_INT64_OPS_PICO=1
DEFINES += -DPICO_MEM_OPS_PICO=1
DEFINES += -DPICO_NO_FLASH=0
DEFINES += -DPICO_NO_HARDWARE=0
DEFINES += -DPICO_ON_DEVICE=1
DEFINES += -DPICO_PRINTF_PICO=1
DEFINES += -DPICO_STDIO_UART=1
DEFINES += -DPICO_USE_BLOCKED_RAM=0
DEFINES += -DRP2040_USB_DEVICE_MODE=1
DEFINES += -DTINYUSB_DEVICE_LINKED=1
DEFINES += -DPICO_TARGET_NAME=\"kermite\"
DEFINES += -DPICO_PROGRAM_URL=\"https://github.com/kermite-org/Kermite/tree/master/firmware\"
DEFINES += -DPICO_BOOTSEL_VIA_DOUBLE_RESET_TIMEOUT_MS=700
...
SDK_C_SRCS += $(PICO_SDK_DIR)/src/rp2_common/binary_info.c
